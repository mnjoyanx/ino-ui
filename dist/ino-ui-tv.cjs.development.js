...
var InoInput = function InoInput(_ref) {
  ...
  return React__default.createElement("div", {
    ref: containerRef,
    className: "ino-input ino-input--" + variant + " " + (isActive ? 'ino-input--focused' : '') + " " + (disabled ? 'ino-input--disabled' : '') + " " + classNames,
    onClick: handleFocus,
    role: "textbox",
  ...
  }, "|"), displayValue.slice(cursorPosition)), !displayValue && React__default.createElement("span", {
