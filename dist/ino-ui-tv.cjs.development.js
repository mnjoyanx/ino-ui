...
var InoCol = function InoCol(props) {
  var parent = React__default.useContext(React__default.createContext(null));
  ...
  }, React__default.Children.map(props.children, function (child, idx) {
    if (React__default.isValidElement(child)) {
...
var InoSidebar = function InoSidebar(_ref) {
  ...
  if (loading) {
    return React__default.createElement("aside", {
      ...
      return React__default.createElement(InoSkeletonListItem, {
        key: index,
        avatarSize: 3.2,
        lines: collapsed ? 0 : 1
      });
  ...
  return React__default.createElement("aside", {
    ...
    }, item.icon), !collapsed && React__default.createElement("span", {
