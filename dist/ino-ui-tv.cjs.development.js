...
var GridView = /*#__PURE__*/React.memo(function (_ref) {
  ...
  React.useEffect(function () {
    var calculateDimensions = function calculateDimensions() {
      ...
      var totalItems = itemsTotal || data.length;
      var calculatedRowItems = rowItemsCount || Math.floor(Math.sqrt(totalItems));
      var calculatedRows = rowCount || Math.ceil(totalItems / calculatedRowItems);
      var calculatedItemWidth = itemWidth || 15;
      var calculatedItemHeight = itemHeight || 15;
      setDimensions({
    ...
    calculateDimensions();
  }, [itemWidth, itemHeight, rowItemsCount, rowCount, itemsTotal, data.length]);
